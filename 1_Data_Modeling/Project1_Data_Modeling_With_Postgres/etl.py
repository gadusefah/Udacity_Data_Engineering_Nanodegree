...
def process_log_file(cur, filepath):
    ...
    time_data = [[row, row.hour, row.day, row.week, row.month, row.year, row.day_name()] for row in t]
...
def main():
    conn = psycopg2.connect("host=127.0.0.1 dbname=sparkifydb user=sparkifydb password=sparkifydb")
